                ...
                <AnimatePresence>
                    {canScrollLeft && (
                        <motion.button
                            ...
                            exit={{ opacity: 0 }}
                            onClick={() => scroll("left")}
                            className="absolute left-4 top-1/2 -translate-y-1/2 backdrop-blur-md rounded-full p-2 shadow-lg"
                        >
                ...
                <AnimatePresence>
                    {canScrollRight && (
                        <motion.button
                            ...
                            className="absolute right-4 top-1/2 -translate-y-1/2 backdrop-blur-md rounded-full p-2 shadow-lg"
                        >
